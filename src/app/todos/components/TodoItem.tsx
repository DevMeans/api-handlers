...
export const TodoItem = ({ todo, toggleTodo }: Props) => {
  ...
  const onToggleTodo = async () => {
    try {
      ...
      startTransition(() => toggleTodoOptimistic(!todoOptimistic.complete))
      //vuelve al estado normal cuando fue cambiando automaticamente 
    }
  }
  return (
    <div className={todoOptimistic.complete ? styles.todoDone : styles.todoPending}>
      <div className='flex flex-col sm:flex-row justify-start items-center gap-4'>
        <div
          ...
          {
            todoOptimistic.complete ? <IoCheckboxOutline size={30}></IoCheckboxOutline> : <IoSquareOutline size={30}></IoSquareOutline>
          }
        </div>
